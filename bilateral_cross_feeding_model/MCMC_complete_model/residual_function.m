...
%% unpack parameters
parameters = [3.61e-12;  ... Maximum glucose uptake rate, mmol/h
              params(1); ... Michaelis constant for glucose uptake, mM
              params(2); ... Maximum lysine uptake rate by the lysine auxotroph, mmol/h
              params(3); ... Maximum lysine uptake rate by the leucine auxotroph, mmol/h
              params(4); ... Maximum leucine uptake rate by the lysine axutroph, mmol/h
              params(5); ... Maximum leucine uptake rate by the leucine axutroph, mmol/h
              ...
              params(6); ... Fraction of glucose uptake allocated to lysine production
              params(7); ... Fraction of glucose uptake allocated to leucine production
              params(8); ... Lysine leakage fraction of the leucine auxotroph
              params(9); ... Leucine leakage fraction of the lysine auxotroph
              3.00e11;   ... Biomass yield of E. coli grown on glucose, 1/mmol
              params(10);... Biomass yield of E. coli grown on lysine, 1/mmol
              params(11);... Biomass yield of E. coli grown on leucine, 1/mmol
              params(12);... Mortality rate constant of the lysine auxotroph, 1/h
              params(13) ... Mortality rate constant of the leusine auxotroph, 1/h
             ];
...
[tK,yK] = ode15s(@lys_leu_bilateral_cf_complete_model,           ... Model
...
[tL,yL] = ode15s(@lys_leu_bilateral_cf_complete_model,           ... Model
                 [0,15],                                ... Time interval of integration (unit: h)
...
[tKL,yKL] = ode15s(@lys_leu_bilateral_cf_complete_model,           ... Model
