...
parameters = [params(1), ... Maximum glucose uptake rate of CV101, mmol/h
              ...
              params(7), ... Half-inhibition constant for CV101 growth by acetate, mM
              params(8), ... Half-inhibition constant for CV103 growth by acetate, mM
              ...
              params(6), ... Biomass yield of E. coli grown on acetate
              params(5), ... Acetate leakage fraction (percentage of carbon loss)
