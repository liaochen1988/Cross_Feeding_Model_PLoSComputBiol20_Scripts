function [dxdt,J_grow] = acetate_mediated_cf_complete_model(t, x, D, G_fm, A_fm, params)
...
% gamma_g:   biomass yield of E. coli grown on non-explicitly-modeled building blocks
% gamma_a:   biomass yield of E. coli grown on acetate
% phi_a:     fraction of glucose influx allocated to biosynthesis of acetate
% varphi_a:  acetate leakage fraction
% delta_a:   number of acetate molecules produced per molecule of glucose is consumed

params_cell = num2cell(params);
[V_1_g, V_3_g, K_g, I_1_a, I_3_a, C_1_g, V_1_a, K_1_a, gamma_g, gamma_a, phi_a, varphi_a, delta_a] = params_cell{:};
...
J_syn_1_a = delta_a*J_upt_1_g*phi_a;
J_syn_3_a = delta_a*J_upt_3_g*phi_a;

% Leakage flux
J_leak_1_a = J_syn_1_a * varphi_a;
J_leak_3_a = J_syn_3_a * varphi_a;

% Specific growth rate is inhibited by acetate
J_grow_1 = min(gamma_g*J_upt_1_g*(1-phi_a), gamma_a*((1-varphi_a)*J_syn_1_a+J_upt_1_a))*I_1_a/(I_1_a+Ace);
J_grow_3 = min(gamma_g*J_upt_3_g*(1-phi_a), gamma_a*((1-varphi_a)*J_syn_3_a))*I_3_a/(I_3_a+Ace);
...
dxdt(4) = D*(A_fm-Ace)+(J_leak_1_a-J_upt_1_a)*CV101_a+J_leak_3_a*CV103_a;  % acetate
end
